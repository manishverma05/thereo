...
<!-- Modal Fullscreen -->
<div class="modal fade modal-fullscreen" id="modal-mediaPopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <section id="filter">
                            ...
                            <div class="col-md-12 responder_table"> 
                                ...
                                <div class="row articles-wrapper gallery-grid">
                                    ...
                                    @endphp
                                    <!-- START: single grid -->
                                    <div class="col-sm-3 covercontainer" onclick="updateMedia(this)" style="padding: 2px;">
