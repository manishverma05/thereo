...
<!-- Modal Fullscreen -->
<div class="modal fade modal-fullscreen" id="modal-publication" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="resource_add">
                                        <a href="javascript:void(0)" onclick="formSubmit('1');">Yes</a>
                                    </td>
                                </tr>
