...
<!-- Modal Fullscreen -->
<div class="modal fade modal-fullscreen" id="modal-productPopup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="gallery_wrap">
                        ...
                        <section id="filter">
                            <div class="filter_hd" style="margin-bottom: 5px;margin-top: 5px;">
                                <p>Upload a new image, or select on from the library below, to attach it as a product, to the article you wish to make.</p>
                            ...
                            <div class="col-md-12 responder_table"> 
                                ...
                                <div class="row articles-wrapper gallery-grid">
                                    ...
                                    @endphp
                                    <!-- START: single grid -->
                                    <div class="col-sm-3 covercontainer" onclick="updateProduct(this)" style="padding: 2px;">
