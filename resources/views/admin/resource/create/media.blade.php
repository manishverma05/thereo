...
<form action="{{ route("admin.$relatedTo.resource.create.media",[$$relatedTo->unique_id]) }}" method="post" enctype="multipart/form-data" id="form">
    @csrf 
        ...
        <div id="media-tab" class="tab-pane fade in active">
            ...
            <section class="local_start_wrapper">
                ...
                <div class="col-sm-12 artcover">
                    <p>Product Attachment: This resource is currently attached to the media displayed below.</p>
                    <a href="#" data-toggle="modal" data-target="#modal-mediaPopup">Attach Media</a>
                </div> 
                <div class="imagewrap">
                    <div class="col-sm-3 covercontainer">
                        <img src="{{ asset(config('constants.media.default_media_path_display')) }}" alt="media Image" id="media_preview" class="image" style="width:100%">
                        <div class="middle">
                            <div class="text media_name"></div>
                        </div>
                    </div>
                    <input type="hidden" name="media_id" value=""/>
                    <div class="col-sm-9 editimg media_detail" style="display: none;">
                        <div class="postnbotm">
                            <h5 class="media_name"></h5>
                        </div>
                    </div>  
                </div>
            </section>
