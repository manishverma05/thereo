...
$filename = '';
if(isset($programCategory->cover_media->file)):
$filename = $programCategory->cover_media->file; 
$cover_image = asset(config('constants.program.category.cover_path_display').$programCategory->cover_media->file);
$cover_image_thumb = asset(config('constants.program.category.cover_path_display').'thumb_'.$programCategory->cover_media->file);
endif;
@endphp
<!-- Start Navigation -->
<form action="{{ route('admin.program.category.update',[$programCategory->unique_id]) }}" method="post" enctype="multipart/form-data">
    @csrf 
    <input type="hidden" name="category_id" value="{{ $programCategory->id }}"/>
    ...
    <div class="tab-content">
        <div id="category-tab" class="tab-pane fade in active">
            ...
            <div class="col-sm-12 artctitle">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="title" value="{{ old('title',$programCategory->title) }}" placeholder="Enter the title for the category.">
                </div>
            </div> 
        </div>
        <div id="meta-tab" class="tab-pane fade in">
            ...
            <div class="col-sm-12 artclmeta">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="slug" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="{{ old('slug',$programCategory->slug)}}" placeholder="Enter prefer path without spaces.">
                </div>
            </div> 
        </div>
        <div id="cover-tab" class="tab-pane fade in">
            ...
            <div class="col-sm-12 artctitle">
                ...
                <div class="form-group">
                    <input type="text" class="form-control"  value="{{ old('cover_title',$programCategory->cover_title) }}" name="cover_title">
                </div>
            </div> 
            ...
            <div class="col-sm-12 imagewrap">
                ...
                <div class="col-sm-9 editimg" @if(!$filename) {{ 'style=display:none;' }} @endif>
                     <div class="postnbotm" >
                        ...
                        <p class="editimgLink" ><a href="javascript:void(0)">Edit Image</a></p>
                    </div>
                </div>      
            </div>
        </div>        
<!--        <div id="public-tab" class="tab-pane fade in">
            ...
            <div class="col-sm-12 appearence">
                ...
                <ul>
                    <li>Schedule for Republication <input type="date" name="publish" value="{{ old('publish',$programCategory->publish_on) }}"/></li>
            ...
            <div class="col-sm-12 appearence">
                ...
                <ul>
                    <li>Schedule for Republication <input type="date" name="unpublish" value="{{ old('unpublish',$programCategory->unpublish_on) }}"/></li>
