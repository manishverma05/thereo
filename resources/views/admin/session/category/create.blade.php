...
<div class="rjadmin_back"><a href="{{ route('admin.session.list') }}">Return to Sessions</a></div>
...
<!-- Start Navigation -->
<form action="{{ route('admin.session.category.create') }}" method="post" enctype="multipart/form-data" id="form">
    @csrf 
