                            ...
                            <div class="rj_program">
                                <div class="rj_program_inner blk">
                                    <a href="{{ route('user.program.session.list',[$program->slug.'#'.$session->session->slug]) }}">
                                        ...
                                        <div class="menu_name white_opacity1">{{ ++$sessionIndex }}. {{ $session->session->cover_title ? $session->session->cover_title : $session->session->title }}</div>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="rj_program">
                                <div class="rj_program_inner blk">
                                    <a href="javascript:void(0)">
                                        ...
                                        <div class="menu_name">{{ ++$sessionIndex }}. {{ $session->session->cover_title ? $session->session->cover_title : $session->session->title }}</div>
