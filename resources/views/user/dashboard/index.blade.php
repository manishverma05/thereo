    ...
    <body class="rj_admin_panel">
        <div class="container">
            ...
            <div class="row breadcrumb-section">
                <div class="col-md-12">
                    <div class="rjadmin_bar"><a href="{{ route('user.dashboard') }}" class="rjadmin_active"><i class="fa fa-bars"></i></a></div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-4">
                    ...
                    <div class="rjadmin_breadcrumb_right">
                        <div class="rjadmin_back"><a href="{{ route('user.logout') }}">Logout</a></div>
                    </div>
                </div>
            </div>
            <!-- End Admin Header -->
            @include('user._partial.message')
            @yield('content')
        </div>
        <!-- Scripts -->
